        ...
        <div className="fixed bottom-0 left-0 z-[60] w-full">
            <div className="flex items-center justify-between rounded-t-[32px] bg-card/80 px-6 pb-10 pt-4 shadow-[0_-8px_30px_rgba(0,0,0,0.04)] backdrop-blur-2xl">
                ...
                <Button
                    ...
                    className="rounded-xl h-auto bg-gradient-to-br from-primary to-primary/80 px-10 py-4 font-headline text-sm font-bold tracking-wide shadow-lg shadow-primary/20 transition-transform active:scale-95"
                >
                    Reserve Now
                </Button>
            </div>
