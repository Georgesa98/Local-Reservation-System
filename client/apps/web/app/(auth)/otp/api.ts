 ...
 */
export async function initiateOTP(phoneNumber: string): Promise<InitiateOTPResponse> {
  try {
 ...
 */
export async function fetchOTPData(phoneNumber: string): Promise<OTPChannelInfo> {
